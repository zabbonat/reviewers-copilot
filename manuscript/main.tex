...
The longitudinal scientometric dataset ($N=22,479$ records) and the 400-case evaluation benchmark pool are openly available on GitHub at \url{https://github.com/checkifexist/reviewers-copilot} and from the corresponding author upon reasonable request.

\section*{Code Availability Statement}
The core backend verification engine and frontend UI dashboard source code for \textit{CheckIfExist} are publicly released under an MIT License on GitHub at \url{https://github.com/checkifexist/reviewers-copilot}.
